...
const NavbarComponent = () => {
  ...
  return (
    ...
    <nav className="navbar navbar-expand-lg navbar-light bg-light border border-secondary mx-4 py-0">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0 mx-auto" >
            <li className="nav-item">
              <Link className="nav-link animate__animated animate__backInLeft" aria-current="page" to={"/"}>
                Home
              </Link>
            </li>
          ...
          <div className="dropdown-menu ulDiv" aria-labelledby="navbarDropdown">
            ...
            <li className="nav-item dropdown">
          <Link className="nav-link dropdown-toggle animate__animated animate__backInRight" to={"/"} id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          More
          </Link>
          <div className="dropdown-menu ulDiv" aria-labelledby="navbarDropdown">
            <ul className="d-flex navUl">
          ...
          <div className="nav-item dropdown user">
              <Link
                ...
                aria-expanded="false"
              ></Link>
              <ul className="dropdown-menu dropdown-menu-end animate__animated animate__slideInDown " aria-labelledby="navbarDropdown">
                {!userStore?.email ? (
                  <>
                    <li>
          ...
          <div className="dropdown searchDrop ">
            ...
            <ul className="dropdown-menu dropdown-menu-end animate__animated animate__slideInDown px-2" aria-labelledby="dropdownMenu2">
